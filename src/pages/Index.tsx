  ...
  >
    Get In Touch
              ...
              <div className="flex gap-4">
                <a href="https://github.com/Mereena02/" target="_blank" rel="noopener noreferrer" className="glass-card p-3 hover-glow transition-all duration-300">
                  <Github className="w-6 h-6 text-primary" />
                </a>
                <a href="https://www.linkedin.com/in/mereena-bodanapu/" target="_blank" rel="noopener noreferrer" className="glass-card p-3 hover-glow transition-all duration-300">
                  <Linkedin className="w-6 h-6 text-secondary" />
                </a>
                <a href="mailto:mereenabodanapu02@gmail.com" className="glass-card p-3 hover-glow transition-all duration-300">
            ...
            <div className="flex justify-center lg:justify-end animate-fade-in-right">
              <div className="relative">
                <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden glass-card">
                  <img
                    src="/my-uploads/7cb11d01-4ad2-448d-bcb7-baf2904e631f.jpg"
                    alt="Mereena Bodanapu"
          ...
          <div className="glass-card p-12 animate-zoom-in">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg md:text-xl leading-relaxed text-muted-foreground">
                I'm 
                <span className="text-foreground font-semibold"> MEREENA BODANAPU</span> a final-year Computer Science Engineering student at Mohan Babu University, currently holding a CGPA of 9.21. With a strong passion for AI, edtech, and scalable systems, I specialize in developing full-stack solutions that blend futuristic design with robust logic.
      ...
      {[
        {
          ...
          github: "https://github.com/Mereena02/CodeKid",
          live: "https://code-kid-vr2g.vercel.app/",
        ...
        },
        {
          ...
          github: "https://github.com/Mereena02/FIRST-AID-AI",
          live: "https://first-aid-ai-yxmzhcobjpoc8blyp5obuy.streamlit.app/",
          image: "/AI-D.png",
        },
        {
          title: "CubeCrack",
          description: "A smart web app that helps solve Rubik’s Cubes using image input and AI-powered cube state detection.",
          github: "https://github.com/Mereena02/Rubik-s_AI",
          live: "https://rubik-sai-tkd7fmxavgjlaeffyx8pej.streamlit.app/",
          image: "/CubeCrack.png",
        },
      ].map((project, index) => (
        <div
            ...
            <div className="glass-card p-8 animate-slide-in-left">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-muted-foreground">mereenabodanapu02@gmail.com</span>
                </div>
                <div className="flex items-center gap-4">
                  <Phone className="w-6 h-6 text-secondary neon-glow" />
                  <span className="text-muted-foreground">+91 7207733373</span>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a href="https://github.com/Mereena02/" target="_blank" rel="noopener noreferrer" className="glass-card p-4 hover-glow transition-all duration-300">
                    <Github className="w-6 h-6 text-primary" />
                  </a>
      ...
      <footer className="py-12 px-6 border-t border-border">
        <div className="container mx-auto text-center">
          <p className="text-muted-foreground">
            © 2024 Mereena Bodanapu. All rights reserved.
          </p>
        </div>
      </footer>
